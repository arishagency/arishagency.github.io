...
describe("When compiling tag pages", function () {
    ...
    before(function () {
        ...
        [
            ...
            globalVar.distFolder + "/tag",
            globalVar.distFolder + "/tag/page",
        ...
        fs.writeFileSync(rootPath + globalVar.editFolder + "/templates/partials/loop.hbs", "<ul>{{#each posts}}<li><a href=\"{{url}}\">{{title}}</a></li>{{/each}}</ul>", { encoding: "utf8" });
    ...
    describe("When compiling tag pages", function () {
        before(function (done) {
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post1.json", "{\"slug\":\"test-post1\",\"title\":\"Test post 1\",\"date\":\"2014-06-11\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post2.json", "{\"slug\":\"test-post2\",\"title\":\"Test post 2\",\"date\":\"2014-12-05\",\"tags\":\"mocha coke\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            compileTags(rootPath).then(done, errorStub);
        });

        it("Should create the mocha tag page", function () {
            expect(fs.existsSync(rootPath + globalVar.distFolder + "/tag/mocha/index.html")).to.be.true;
        });

        it("Should create the coke tag page", function () {
            expect(fs.existsSync(rootPath + globalVar.distFolder + "/tag/coke/index.html")).to.be.true;
        });
        ...
        it("Should have the correct mocha tag page content", function () {
            ...
            expect(fs.readFileSync(rootPath + globalVar.distFolder + "/tag/mocha/index.html", "utf8")).to.equal(expectedHtml);
        });
        ...
        it("Should have the correct coke tag page content", function () {
            ...
            expect(fs.readFileSync(rootPath + globalVar.distFolder + "/tag/coke/index.html", "utf8")).to.equal(expectedHtml);
        });
    });
    ...
    describe("When compiling tag pages and excluding draft templates", function () {
        ...
        before(function (done) {
            ...
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post1.json", "{\"slug\":\"test-post1\",\"title\":\"Test post 1\",\"date\":\"2014-06-11\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post2.json", "{\"slug\":\"test-post2\",\"title\":\"Test post 2\",\"date\":\"2014-12-05\",\"status\":\"draft\",\"tags\":\"mocha coke\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
    ...
    describe("When compiling tag posts with pagination", function () {
        before(function (done) {
            ...
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post1.json", "{\"slug\":\"test-post1\",\"title\":\"Test post 1\",\"date\":\"2014-12-05\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post2.json", "{\"slug\":\"test-post2\",\"title\":\"Test post 2\",\"date\":\"2014-12-05\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post3.json", "{\"slug\":\"test-post3\",\"title\":\"Test post 3\",\"date\":\"2014-12-05\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post4.json", "{\"slug\":\"test-post4\",\"title\":\"Test post 4\",\"date\":\"2014-12-05\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post5.json", "{\"slug\":\"test-post5\",\"title\":\"Test post 5\",\"date\":\"2014-12-05\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post6.json", "{\"slug\":\"test-post6\",\"title\":\"Test post 6\",\"date\":\"2014-12-05\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            fs.writeFileSync(rootPath + globalVar.distFolder + "/content/posts/test-post7.json", "{\"slug\":\"test-post7\",\"title\":\"Test post 7\",\"tags\":\"mocha\",\"template\":\"post.hbs\",\"body\":\"<p>Test post content</p>\"}", { encoding: "utf8" });
            compileTags(rootPath).then(done, errorStub);
        });
        ...
        it("Should create the second paginated mocha tag page", function () {
            expect(fs.existsSync(rootPath + globalVar.distFolder + "/tag/mocha/page/2/index.html")).to.be.true;
        });

        it("Should create the third paginated mocha tag page", function () {
            expect(fs.existsSync(rootPath + globalVar.distFolder + "/tag/mocha/page/3/index.html")).to.be.true;
        });
        ...
        it("Should have the correct content for the second paginated page", function () {
            var expectedHtml = "<div>" +
                ...
                "</div>";
            expect(fs.readFileSync(rootPath + globalVar.distFolder + "/tag/mocha/page/2/index.html", "utf8")).to.equal(expectedHtml);
        });
        ...
        it("Should have the correct content for the third paginated page", function () {
            var expectedHtml = "<div>" +
                ...
                "</div>";
            expect(fs.readFileSync(rootPath + globalVar.distFolder + "/tag/mocha/page/3/index.html", "utf8")).to.equal(expectedHtml);
        });
    });
